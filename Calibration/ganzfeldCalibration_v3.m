...
sensor_area_mm2 = 9.7;
sensor_area_m2 = 9.7e-6;
% sensor_pupil_size_correction = pupil_area/sensor_area_mm2

green_power_eye = green_power_pad*sensor_area_m2;
UV_power_eye = UV_power_pad*sensor_area_m2;

%% get light power at the retina calculate Rpup2ret (stationary or locomoting)
